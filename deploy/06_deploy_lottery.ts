...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
    ...
    if (chainId === 31337) {
        ...
        const VRFCoordinatorV2MockDepl = await deployments.get("VRFCoordinatorV2Mock")
        const VRFCoordinatorV2Mock = await ethers.getContractAt("VRFCoordinatorV2Mock", VRFCoordinatorV2MockDepl.address)
